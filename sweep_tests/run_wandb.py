...
def parse_args():
    ...
    parser.add_argument("--dataset_root", type=str, default="/Users/zideng/Work/LDAWT/examples/black_widows_6_17", help="Dataset root")
    parser.add_argument("--image_size", type=int, default=256, help="Image size")
    parser.add_argument("--model", type=str, default="PatchCore", help="Model")
    parser.add_argument("--layers", type=json.loads, default=["layer3", "layer4"], help="Layers")
    parser.add_argument("--backbone", type=str, default="resnet18", help="Backbone")
    parser.add_argument("--training_dir", type=str, default="/Users/zideng/Work/Anomaly/data/black_widows_200", help="Training directory")
...
def main():
    ...
    cfg = dict(wandb.config)  # flat dict of sweep params
    # Only update keys you allow:
    for key in [
        "backbone", 
        "layers", 
